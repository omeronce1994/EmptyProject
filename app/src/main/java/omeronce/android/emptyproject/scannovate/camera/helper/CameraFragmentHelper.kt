...
class CameraFragmentHelper(var fragment: Fragment?, var textureView: AutoFitTextureView?, val file: File){
    ...
    private val stateCallback = object : CameraDevice.StateCallback() {
        ...
        override fun onOpened(cameraDevice: CameraDevice) {
            ...
            this@CameraFragmentHelper.cameraDevice = cameraDevice
        ...
        override fun onDisconnected(cameraDevice: CameraDevice) {
            cameraOpenCloseLock.release()
            cameraDevice.close()
            this@CameraFragmentHelper.cameraDevice = null
        }
    ...
    private fun setUpCameraOutputs(width: Int, height: Int) {
        val activity = this.fragment?.activity ?: return
    ...
    /**
     * Opens the camera specified by [CameraFragmentHelper.cameraId].
     */
            ...
            cameraDevice?.createCaptureSession(Arrays.asList(surface, imageReader?.surface),
                object : CameraCaptureSession.StateCallback() {
                    ...
                    override fun onConfigureFailed(session: CameraCaptureSession) {
                        Toast.makeText(activity, activity.getString(R.string.error_message_unknown), Toast.LENGTH_LONG).show()
                    }
                }, null)
        } catch (e: CameraAccessException) {
            Log.e(TAG, e.toString())
